module points_400 (
    ...
    always @(posedge clk) begin
        ...
        else if (vcount == y + 6 && hcount == x + 1) pixel <= 12'h0FF;
        else if (vcount == y + 6 && hcount == x + 2) pixel <= 12'h000;
        else if (vcount == y + 6 && hcount == x + 3) pixel <= 12'h0FF;
        ...
        else if (vcount == y + 8 && hcount == x + 1) pixel <= 12'h0FF;
        else if (vcount == y + 8 && hcount == x + 2) pixel <= 12'h0FF;
        else if (vcount == y + 8 && hcount == x + 3) pixel <= 12'h0FF;
        ...
        else if (vcount == y + 9 && hcount == x + 3) pixel <= 12'h0FF;
