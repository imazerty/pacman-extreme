module letter_m (
    ...
    always @(posedge clk) begin
        ...
        else if (vcount == y + 2 && hcount == x + 3) pixel <= 12'hFFF;
        ...
        else if (vcount == y + 3 && hcount == x + 1) pixel <= 12'hFFF;
        else if (vcount == y + 3 && hcount == x + 2) pixel <= 12'hFFF;
        ...
        else if (vcount == y + 4 && hcount == x + 1) pixel <= 12'hFFF;
        ...
        else if (vcount == y + 5 && hcount == x + 1) pixel <= 12'hFFF;
        ...
        else if (vcount == y + 6 && hcount == x + 1) pixel <= 12'hFFF;
